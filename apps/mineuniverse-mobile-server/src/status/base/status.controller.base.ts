...
import { ModsFindManyArgs } from "../../mods/base/ModsFindManyArgs";
import { Mods } from "../../mods/base/Mods";
...
export class StatusControllerBase {
  ...
  @common.Get("/:id/modsItems")
  @ApiNestedQuery(ModsFindManyArgs)
  async findModsItems(
    @common.Req() request: Request,
    @common.Param() params: StatusWhereUniqueInput
  ): Promise<Mods[]> {
    const query = plainToClass(ModsFindManyArgs, request.query);
    const results = await this.service.findModsItems(params.id, {
      ...query,
      select: {
        createdAt: true,
        description: true,
  ...
  @common.Post("/:id/modsItems")
  async connectModsItems(
    @common.Param() params: StatusWhereUniqueInput,
    @common.Body() body: ModsWhereUniqueInput[]
  ): Promise<void> {
    const data = {
      modsItems: {
        connect: body,
  ...
  @common.Patch("/:id/modsItems")
  async updateModsItems(
    @common.Param() params: StatusWhereUniqueInput,
    @common.Body() body: ModsWhereUniqueInput[]
  ): Promise<void> {
    const data = {
  ...
  @common.Delete("/:id/modsItems")
  async disconnectModsItems(
    @common.Param() params: StatusWhereUniqueInput,
    @common.Body() body: ModsWhereUniqueInput[]
  ): Promise<void> {
    const data = {
